...
namespace Unity.Muse.Common
{
    ...
    public abstract class Artifact<T> : Artifact
    {
        ...
        /// <param name="useCache">When <b>true</b> will attempt to load the cached representation of this artifact from the local machine's <see cref="GeneratedArtifactCache"/>, and if not found will download it from the client. <b>false</b> will always reach out to the client and update the cache</param>
        ...
        /// <summary>
        /// Writes the serialized Unity representation of this artifact to the <see cref="GeneratedArtifactCache"/>
        /// </summary>
