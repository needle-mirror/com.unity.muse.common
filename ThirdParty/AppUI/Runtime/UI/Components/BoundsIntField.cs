...
namespace Unity.Muse.AppUI.UI
{
    ...
    [UxmlElement]
#endif
    internal partial class BoundsIntField : BaseVisualElement, IInputElement<BoundsInt>, ISizeableElement, INotifyValueChanging<BoundsInt>
    {
#if ENABLE_RUNTIME_DATA_BINDINGS
        ...
        /// </summary>
        internal new class UxmlFactory : UxmlFactory<BoundsIntField, UxmlTraits> { }
