...
namespace Unity.Muse.AppUI.UI
{
    ...
    [UxmlElement]
#endif
    internal partial class RectIntField : BaseVisualElement, IInputElement<RectInt>, ISizeableElement, INotifyValueChanging<RectInt>
    {
#if ENABLE_RUNTIME_DATA_BINDINGS
        ...
        /// </summary>
        internal new class UxmlFactory : UxmlFactory<RectIntField, UxmlTraits> { }
