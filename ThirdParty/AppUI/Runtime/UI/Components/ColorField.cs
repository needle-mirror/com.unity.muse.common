...
namespace Unity.Muse.AppUI.UI
{
    ...
    [UxmlElement]
#endif
    internal partial class ColorField : ExVisualElement, IInputElement<Color>, INotifyValueChanging<Color>, ISizeableElement, IPressable
    {
#if ENABLE_RUNTIME_DATA_BINDINGS
        ...
        /// </summary>
        internal new class UxmlFactory : UxmlFactory<ColorField, UxmlTraits> { }
