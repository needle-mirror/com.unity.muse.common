...
namespace Unity.AppUI.Redux
{
    ...
    internal record Meta<TThunkArg>(ThunkStatus thunkStatus)
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TThunkArg"> The type of the argument to pass to the thunk. </typeparam>
    internal record PendingMeta<TThunkArg>() : Meta<TThunkArg>(ThunkStatus.Pending);

    /// <summary>
    /// The metadata of the thunk when it is fulfilled.
    /// </summary>
    /// <typeparam name="TThunkArg"> The type of the argument to pass to the thunk. </typeparam>
    internal record FulfilledMeta<TThunkArg>() : Meta<TThunkArg>(ThunkStatus.Fulfilled);

    /// <summary>
    /// The metadata of the thunk when it is rejected.
    /// </summary>
    /// <typeparam name="TThunkArg"> The type of the argument to pass to the thunk. </typeparam>
    internal record RejectedMeta<TThunkArg>() : Meta<TThunkArg>(ThunkStatus.Rejected)
    {
        /// <summary>
