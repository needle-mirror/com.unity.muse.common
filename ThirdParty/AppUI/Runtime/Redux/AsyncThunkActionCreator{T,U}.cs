...
namespace Unity.AppUI.Redux
{
    ...
    /// <typeparam name="TThunkArg"></typeparam>
    internal class AsyncThunkActionCreator<TPayload, TThunkArg>
    {
        /// <summary>
        /// The payload creator signature for the thunk.
        /// </summary>
        internal delegate Task<TPayload> PayloadCreator(TThunkArg arg, ThunkAPI<TPayload,TThunkArg> thunkAPI, CancellationToken cancellationToken);
